...
var v1 = '/api/v1/';
var entity = 'administrationroute';
var AdministrationroutePath = v1 + entity + 's/';
var controllerPath = ['../../app/controllers/', '.server.controller'];
var controller = require(controllerPath[0] + 'administrationroutes' + controllerPath[1]);
...
module.exports = function(app) {
  // State's routes
  app.route(AdministrationroutePath)
